...
/**
 * Déploie l'activation/désactivation des rubriques d'accueil.
 * Usage: php deploy-home-sections-once.php /chemin/vers/projet
 */
...
$files = [
  ...
  'app/Filament/Pages/ManageHomeSections.php',
  'app/Filament/Pages/ManageHomePromos.php',
