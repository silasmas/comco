...
/**
 * Corrige affichage Mission + justification RichEditor.
 * Usage: php deploy-mission-justify-once.php /chemin/vers/projet
 */
...
$files = [
  ...
  'app/Filament/Resources/Pages/RelationManagers/LegalDocumentsRelationManager.php',
