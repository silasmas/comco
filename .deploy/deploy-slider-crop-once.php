...
/**
 * Restaure le slider cover + active le rognage upload (sans upscale).
 * Usage: php deploy-slider-crop-once.php /chemin/vers/projet
 */
...
$files = [
  'app/Support/CroppableImageUpload.php',
